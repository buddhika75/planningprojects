 ...
 * @author Windhelm
 */
class ApplicantProjectProponent {
    private String nameOfAgency;
    private String addressOfAgency;
    private String phoneOfAgency;
    private String faxOfAgency;
    ...
    public String getAddressOfAgency() {
        return addressOfAgency;
    }

    public void setAddressOfAgency(String addressOfAgency) {
        this.addressOfAgency = addressOfAgency;
    }

    public String getPhoneOfAgency() {
        return phoneOfAgency;
    }

    public void setPhoneOfAgency(String phoneOfAgency) {
        this.phoneOfAgency = phoneOfAgency;
    }

    public String getFaxOfAgency() {
        return faxOfAgency;
    }

    public void setFaxOfAgency(String faxOfAgency) {
        this.faxOfAgency = faxOfAgency;
    }
